...
class ClassificationAlexNet(nn.Module):
    ...
    def __init__(self, n):
        ...
        self.model = nn.Sequential(*list(model.children())[:-1],
                                   Flatten(),
                                   nn.Linear(in_features=512, out_features=n, bias=True))
...
optimizer = torch.optim.SGD([{'params': net.model1.parameters(), 'lr': lr},
                             {'params': net.model2.parameters(), }], lr=lr, momentum=0.9)
